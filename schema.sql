...
CREATE TABLE IF NOT EXISTS "ΞΕΝΟΣ ΠΑΙΚΤΗΣ" (
    ...
    PRIMARY KEY ("μητρώο_μέλους"),
    FOREIGN KEY ("μητρώο_μέλους") REFERENCES "ΠΑΙΚΤΗΣ" ("μητρώο_μέλους") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "ΑΜΕΙΒΟΜΕΝΟΣ ΠΑΙΚΤΗΣ" (
    ...
    PRIMARY KEY ("μητρώο_μέλους"),  -- Συνθετό πρωτεύον κλειδί με τα πεδία RN και μητρώο_μέλους
    FOREIGN KEY ("μητρώο_μέλους") REFERENCES "ΠΑΙΚΤΗΣ ΤΗΣ ΟΜΑΔΑΣ" ("μητρώο_μέλους")
			ON DELETE CASCADE
			ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS "ΠΡΟΣΩΠΙΚΟ" (
	...
	"τηλέφωνο" CHAR(10) CHECK ("τηλέφωνο" GLOB '[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'),
	"όνομα" varchar COLLATE NOCASE,
	"επώνυμο" varchar COLLATE NOCASE,
...
CREATE TABLE IF NOT EXISTS "ΣΥΝΔΡΟΜΗ" (
    ...
    "πακέτο συνδρομής" VARCHAR CHECK ("πακέτο συνδρομής" IN ('2 αδέλφια', '3 αδέλφια', 'Ξένος Παίκτης', 'Παίκτης της Ομάδας','Κανονικη')),
    "κωδικός συνδρομής" INTEGER PRIMARY KEY
);



INSERT INTO "ΜΕΛΟΣ" ("μητρώο_μέλους", "επώνυμο", "όνομα", "ημερομηνία_γέννησης", "επίπεδο", "τηλέφωνο", "φύλο", "πλήθος_αδελφών")
VALUES
...
('0030', '27136'),
('0031', '19938');
INSERT INTO "ΞΕΝΟΣ ΠΑΙΚΤΗΣ" ("μητρώο_μέλους", "ομάδα")
VALUES
('0016', 'ΑΟ ΔΙΟΓΕΝΗΣ ΠΑΤΡΑΣ'),
('0019', 'ΑΟ ΦΟΙΝΙΚΑΣ ΠΑΤΡΩΝ 2010'),
('0029', 'ΑΟ ΠΑΤΡΑΣ ΠΑΓΩΝΑ'),
('0030', 'ΑΟ ΔΙΟΓΕΝΗΣ ΠΑΤΡΑΣ'),
('0031', 'ΑΟ ΦΟΙΝΙΚΑΣ ΠΑΤΡΩΝ 2010');

INSERT INTO "ΠΑΙΚΤΗΣ ΤΗΣ ΟΜΑΔΑΣ"("μητρώο_μέλους","ήττες","νίκες","points","κατηγορία")
VALUES
('0001',2,5,2395,'Α2 Εθνική Ελλάδας Ανδρών'),
('0002',2,4,2362,'Α2 Εθνική Ελλάδας Ανδρών'),
('0003',2,4,2157.1,'Α2 Εθνική Ελλάδας Ανδρών'),
('0004',4,1,1567.6,'Α2 Εθνική Ελλάδας Ανδρών'),
('0005',0,0,1093.7,'Α2 Εθνική Ελλάδας Ανδρών'),
('0006',4,0,520.8,'Α Τοπικό Δυτικής Ελλάδας Ανδρών'),
('0007',0,2,269.2,'Α Τοπικό Δυτικής Ελλάδας Ανδρών'),
('0008',0,2,239.6,'Α Τοπικό Δυτικής Ελλάδας Ανδρών'),
('0009',0,0,200,'Α Τοπικό Δυτικής Ελλάδας Ανδρών'),
('0010',0,1,196.3,'Α Τοπικό Δυτικής Ελλάδας Ανδρών'),
('0011',0,3,174.8,'Α Τοπικό Δυτικής Ελλάδας Ανδρών'),
('0012',3,1,458.5,'Β Εθνική Δυτικής Ελλάδας Γυναικών'),
('0013',1,2,386.6,'Β Εθνική Δυτικής Ελλάδας Γυναικών'),
('0014',3,2,260.5,'Β Εθνική Δυτικής Ελλάδας Γυναικών'),
('0015',1,3,258.6,'Β Εθνική Δυτικής Ελλάδας Γυναικών');
INSERT INTO "ΑΜΕΙΒΟΜΕΝΟΣ ΠΑΙΚΤΗΣ" ("μητρώο_μέλους", "ΑΦΜ", "αμοιβή", "ημερομηνία έναρξης συμβολαίου", "ημερομηνία λήξης συμβολαίου", "IBAN")
VALUES
('0001', '123532654', 5000, '2024-08-15', '2026-08-15', 'GR2101234567890123456789012'),
('0002', '542871639', 3000, '2024-08-15', '2025-08-15', 'GR3502345678901234567890123'),
('0003', '108734256', 2000, '2023-09-12', '2027-09-12', 'GR4703456789012345678901234'),
('0004', '451892637', 1000, '2022-09-06', '2027-09-06', 'GR6305678901234567890123456');

INSERT INTO "ΠΡΟΣΩΠΙΚΟ" ("email", "ΑΦΜ", "αμοιβή", "τηλέφωνο", "όνομα", "επώνυμο", "IBAN")
VALUES
('soula.antonios@gmail.com', '151709432', 20, '6996306216', 'ΑΝΤΩΝΙΟΣ', 'ΣΟΥΛΑ', 'GR5604567890123456789012345'),
('g.xouridas@gmail.com', '104114335', 30, '6976194964', 'ΙΩΑΝΝΗΣ', 'ΞΟΥΡΙΔΑΣ', 'GR4801725070005507060762258'),
...
INSERT INTO "ΣΥΝΔΡΟΜΗ" ("τρόπος πληρωμής", "πακέτο συνδρομής", "κωδικός συνδρομής") 
VALUES
('Μετρητά', '2 αδέλφια', 1),
('Μετρητά', '3 αδέλφια', 2),
